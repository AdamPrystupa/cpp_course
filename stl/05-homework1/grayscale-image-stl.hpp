...
Ulepsz program grayscale-images z poprzedniej pracy domowej (kompresja,
dekompresja) obrazków, tak, aby zamiast pętli wykorzystać algorytmy. Działaj na
swojej/waszej wersji implementacji tego zadania.*/
...
CompressedData compressGrayscaleAlgo(const Bitmap &);
Bitmap decompressGrayscaleAlgo(const CompressedData &);
